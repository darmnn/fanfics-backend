...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "books/{id}/like").hasAuthority(READ.getPermission())
                .antMatchers(HttpMethod.POST, "books/{id}/dislike").hasAuthority(READ.getPermission())
                .antMatchers(HttpMethod.OPTIONS, "books/{id}/like").permitAll()
                .antMatchers(HttpMethod.OPTIONS, "books/{id}/dislike").permitAll()
